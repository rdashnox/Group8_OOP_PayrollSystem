    ...
    private void loginUser() {
        ...
        try {
            ...
            if (loggedInUser != null) {
                ...
                boolean isFirstLogin = roleAuthenticator.checkFirstLogin(username);
                ...
                if (isFirstLogin) {
                    ...
                    if (designation.contains("Rank and File")) {
                        new EmployeeDashboard(
                            ...
                            username // to pass username to dashboard
                        ).setVisible(true);
                    } else {
                        new AdminDashboard(
                            username, // to pass username to AdminDashboard
                            connection
                        ).setVisible(true);
                    }
                }
            ...
            if (isFirstLogin) {
                ...
                if (designation.contains("Rank and File")) {
                    new EmployeeDashboard(
                        ...
                        loggedInUser.getTotalDeductions(),
                        loggedInUser.getNetPay(),
                        username // Pass username to dashboard
                    ).setVisible(true);
                } else {
                    new AdminDashboard(
                        username, // Pass username to AdminDashboard
                        connection
                    ).setVisible(true);
                }
            }
