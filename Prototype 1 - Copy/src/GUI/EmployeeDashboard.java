...
public class EmployeeDashboard extends javax.swing.JFrame {
    ...
    
    {
        ...
        this.basicPayLabel.setText(formatCurrency(basicPay));
    ...
    private void updateUI() {
        try {
            ...
            // Used to extract all values needed for the UI
    ...
    private void payrollLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_payrollLabelMouseClicked
        ...
        // Make sure EmployeeDashboard has a connection field
        if (this.connection == null) {
            this.connection = DatabaseConnection.getInstance().getConnection();
        }
        
        // Open PayrollDashboard and pass the username and connection
        new PayrollDashboard(this.username, this.connection).setVisible(true);
        this.dispose();
    } catch (Exception ex) {
        JOptionPane.showMessageDialog(this, 
            "Error opening PayrollDashboard: " + ex.getMessage(), 
